      ...
      <div class="grid h-full max-w-lg grid-cols-4 mx-auto items-center justify-center">
        <a href="/">
          ...
          group-hover:text-blue-600 dark:group-hover:text-blue-500 mb-1"
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400 hover:text-[black]">
              Home
            </span>
          </button>
        </a>
        ...
        >
          ...
          group-hover:text-blue-600 dark:group-hover:text-blue-500 mb-1"
            ...
            <span
              class={
                info !== "orders"
                  ? "text-sm text-gray-500 dark:text-gray-400  group-hover:text-[black]"
                  : "text-sm text-gray-500 dark:text-gray-400  group-hover:text-blue-500"
              }
            >
              Mis Pedidos
            </span>
        ...
        <div class="inline-flex flex-col items-center justify-center px-4  text-[#6B7280]  hover:text-[black] text-sm">
          <svg
            class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
            xmlns="http://www.w3.org/2000/svg"
            width="800px"
