  ...
  return (
    <section className="flex flex-col mt-[2%]" id="down">
      <section className="mx-2 flex  flex-col lg:flex-row lg:justify-evenly">
        ...
        <div className="lg:w-7/12 grid h-56 grid-cols-1 gap-4 sm:h-64 xl:h-80 2xl:h-[400px] border border-neutral-900 rounded-sm">
          <Carousel
            leftControl={
              ...
              ? offers1?.map((product) => {
                  return (
                    ...
                    >
                      ...
                      <img
                        className="w-[500px] h-[300px] m-auto my-2 relative z-0"
