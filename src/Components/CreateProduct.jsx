      ...
      <div className="bg-white w-full h-[750px] rounded-lg flex flex-col items-center justify-evenly ">
        ...
        {category === "Celular" && (
          ...
          >
            ...
            <div className="w-full flex m-2 justify-evenly">
              <div className="flex flex-col justify-start items-start">
                <label className="text-lg font-medium">Memoria interna</label>
                <input
                  autocomplete="off"
              ...
              <div className="flex flex-col justify-start items-start">
                <label className="text-lg font-medium">Camara Principal</label>
                <input
                  autocomplete="off"
        ...
        {category === "TV" && (
          ...
          >
            ...
            <div className="w-full flex m-2 justify-evenly">
              ...
              <div className="flex flex-col justify-start items-start">
                <label className="text-lg font-medium">Sistema operativo</label>
                <input
                  autocomplete="off"
